...
exports.logRequestPaths = (req, res, next) => {
  console.log(`Request made to: ${req.url}`); // Log the requested URL to console
...
exports.sendReqParam = (req, res) => {
  let veg = req.params.vegetable; // Get "vegetable" parameter from the URL
...
/*
  ...
  These functions are designed to be used in an Express app as route handlers or middleware.
*/
